...
//Returns a unit vector [x, y, z] normal to the plane defined by the points (x1, y1, z1), (x2, y2, z2), (x3, y3, z3)
function findUnitNormal(x1,y1,z1,x2,y2,z2,x3,y3,z3)
{
  var x4 = x2 - x1;
  var y4 = y2 - y1;
  var z4 = z2 - x1;
  ...
  var y6 = z4*x5 - x4*z5;
  var z6 = x4*y5 - y4*x5;
  var length = Math.sqrt(x6^2 + y6^2 + z6^2);
  return [x6/length, y6/length, z6/length];
}

//Wing_Tip: The half of the wing farthest away from the body
Declare_Any_Class( "Wing_Tip",
  { 'populate'()                 
      { this.positions      = [ 
                                //Top of Wing
                                vec3(0,0,0), vec3(0.9,0,0), vec3(0.9877,0.1564,0.075), 
                                vec3(0,0,0), vec3(0.9877,0.1564,0.075), vec3(0.8560, 0.2781, 0.025),
                                vec3(0,0,0), vec3(0.8560, 0.2781, 0.025), vec3(0.8910, 0.4540, 0.075),
                                vec3(0,0,0), vec3(0.8910, 0.4540, 0.075), vec3(0.7281, 0.5290, 0.025),
                                vec3(0,0,0), vec3(0.7281, 0.5290, 0.025), vec3(0.7071, 0.7071, 0.075),

                                //Bottom of Wing
                                vec3(0,0,0), vec3(0.9,0,0), vec3(0.9877,0.1564,-0.025),
                                vec3(0,0,0), vec3(0.9877,0.1564,-0.025), vec3(0.8560, 0.2781, -0.075),
                                vec3(0,0,0), vec3(0.8560, 0.2781, -0.075), vec3(0.8910, 0.4540, -0.025),
                                vec3(0,0,0), vec3(0.8910, 0.4540, -0.025), vec3(0.7281, 0.5290, -0.075),
                                vec3(0,0,0), vec3(0.7281, 0.5290, -0.075), vec3(0.7071, 0.7071, 0.025),

                                //Sides
                                vec3(0.9,0,0), vec3(0.9877,0.1564,0.075), vec3(0.9877,0.1564,-0.025),

                                vec3(0.9877,0.1564,0.075), vec3(0.9877,0.1564,-0.025), vec3(0.8560, 0.2781, 0.025),
                                vec3(0.8560, 0.2781, 0.025), vec3(0.8560, 0.2781, -0.075), vec3(0.9877,0.1564,-0.025),

                                vec3(0.8560, 0.2781, 0.025), vec3(0.8560, 0.2781, -0.075), vec3(0.8910, 0.4540, 0.075),
                                vec3(0.8910, 0.4540, 0.075), vec3(0.8910, 0.4540, -0.025), vec3(0.8560, 0.2781, -0.075),

                                vec3(0.8910, 0.4540, 0.075), vec3(0.8910, 0.4540, -0.025), vec3(0.7281, 0.5290, 0.025),
                                vec3(0.7281, 0.5290, 0.025), vec3(0.7281, 0.5290, -0.075), vec3(0.8910, 0.4540, -0.025),

                                vec3(0.7281, 0.5290, 0.025), vec3(0.7281, 0.5290, -0.075), vec3(0.7071, 0.7071, 0.075),                      
                                vec3(0.7071, 0.7071, 0.075), vec3(0.7071, 0.7071, -0.025), vec3(0.7281, 0.5290, -0.075),

                                vec3(0,0,0), vec3(0.7071, 0.7071, 0.075), vec3(0.7071, 0.7071, -0.025),
                              ];   
        this.normals        = [ 
                                //Top of Wing
                                vec3(0,0.675,0.1408), vec3(0,0.675,0.1408), vec3(0,0.675,0.1408), 
                                vec3(-0.0120,0.0279,0.0996), vec3(-0.0120,0.0279,0.0996), vec3(-0.0120,0.0279,0.0996), 
                                vec3(0.0095,-0.0419,0.1408), vec3(0.0095,-0.0419,0.1408), vec3(0.0095,-0.0419,0.1408), 
                                vec3(-0.0200,0.0229,0.0995), vec3(-0.0200,0.0229,0.0995), vec3(-0.0200,0.0229,0.0995), 
                                vec3(0.0220, -0.0369,0.1408), vec3(0.0220, -0.0369,0.1408), vec3(0.0220, -0.0369,0.1408), 

                                //Bottom of Wing
                                vec3(0,0.0159,0.0995), vec3(0,0.0159,0.0995), vec3(0,0.0159,0.0995), 
                                vec3(0.0120,-0.0279,-0.0996), vec3(0.0120,-0.0279,-0.0996), vec3(0.0120,-0.0279,-0.0996), 
                                vec3(0.0095,-0.0419,0.1408), vec3(0.0095,-0.0419,0.1408), vec3(0.0095,-0.0419,0.1408), 
                                vec3(0.0200,-0.0229,-0.0995), vec3(0.0200,-0.0229,-0.0995), vec3(0.0200,-0.0229,-0.0995), 
                                vec3(-0.0220,0.0369,-0.1408), vec3(-0.0220,0.0369,-0.1408), vec3(-0.0220,0.0369,-0.1408), 
                                ...
                                //Sides
                                vec3(0.0111,0.0062,0),  vec3(0.0111,0.0062,0),  vec3(0.0111,0.0062,0),

                                vec3(0.0871,0.0943,0), vec3(0.0871,0.0943,0), vec3(0.0871,0.0943,0),
                                vec3(0.0871,0.0943,0), vec3(0.0871,0.0943,0), vec3(0.0871,0.0943,0), 

                                vec3(0.1638,0.0326,0), vec3(0.1638,0.0326,0), vec3(0.1638,0.0326,0),
                                vec3(0.1638,0.0326,0), vec3(0.1638,0.0326,0), vec3(0.1638,0.0326,0),

                                vec3(0.0486,0.1055,0), vec3(0.0486,0.1055,0), vec3(0.0486,0.1055,0),
                                vec3(0.0486,0.1055,0), vec3(0.0486,0.1055,0), vec3(0.0486,0.1055,0),

                                vec3(0.1011,0.0119,0), vec3(0.1011,0.0119,0), vec3(0.1011,0.0119,0),
                                vec3(0.1011,0.0119,0), vec3(0.1011,0.0119,0), vec3(0.1011,0.0119,0),

                                vec3(0.05,-0.05,0),  vec3(0.05,-0.05,0),  vec3(0.05,-0.05,0),
                                ];   
        this.texture_coords = [ 
                                //Top of Wing
...
//Wing_Base: The half of the wing closest to the body
Declare_Any_Class( "Wing_Base",
  { 'populate'()                 
      { this.positions      = [ 
                                //Top of Wing
                                vec3(0,0,0), vec3(0.9,0,0), vec3(0.9877,-0.1564,0.075), 
                                ...
                                vec3(0,0,0), vec3(0.8560, -0.2781, 0.025), vec3(0.8910, -0.4540, 0.075),
                                vec3(0,0,0), vec3(0.8910, -0.4540, 0.075), vec3(0.7281, -0.5290, 0.025),
                                vec3(0,0,0), vec3(0.3536, -0.3536, 0), vec3(0.7281, -0.5290, 0.025),
                                vec3(0.7281, -0.5290, 0.025), vec3(0.7071, -0.85, 0), vec3(0.3536, -0.3536, 0),
                                vec3(0.5, -0.85, 0), vec3(0.7071, -0.85, 0), vec3(0.3536, -0.3536, 0),
                                ...
                                vec3(0,0,0), vec3(0.8560,-0.2781, -0.075), vec3(0.8910, -0.4540, -0.025),
                                vec3(0,0,0), vec3(0.8910, -0.4540, -0.025), vec3(0.7281, -0.5290, -0.075),
                                vec3(0,0,0), vec3(0.3536, -0.3536, 0), vec3(0.7281, -0.5290, -0.075),
                                vec3(0.7281, -0.5290, -0.075), vec3(0.7071, -0.85, 0), vec3(0.3536, -0.3536, 0),
                                vec3(0.5, -0.85, 0), vec3(0.7071, -0.85, 0), vec3(0.3536, -0.3536, 0),
                                ...
                                vec3(0.7071, -0.85, 0), vec3(0.7281, -0.5290, 0.025), vec3(0.7281, -0.5290, -0.075),
                              ];
        this.normals        = [ 
                                //Top of Wing
                                vec3(0,0.0477,0.0995), vec3(0,0.0477,0.0995), vec3(0,0.0477,0.0995),
                                vec3(-0.0169,-0.0395,0.1408), vec3(-0.0169,-0.0395,0.1408), vec3(-0.0169,-0.0395,0.1408),
                                vec3(0.0067,0.0296,0.0996), vec3(0.0067,0.0296,0.0996), vec3(0.0067,0.0296,0.0996),
                                vec3(0.0283,-0.0323,0.1408), vec3(0.0283,-0.0323,0.1408), vec3(0.0283,-0.0323,0.1408),
                                vec3(-0.0088,-0.008,0.0704), vec3(-0.0088,-0.008,0.0704), vec3(-0.0088,-0.008,0.0704),
                                vec3(-0.3614, -0.2574, 0.1239), vec3(-0.3614, -0.2574, 0.1239), vec3(-0.3614,-0.2574,0.1239),
                                vec3(0.1755, 0.1250, 0.0727), vec3(0.1755, 0.1250, 0.0727), vec3(0.1755, 0.1250, 0.0727),
                                
                                //Bottom of Wing
                                vec3(0,0.0225,-0.01408), vec3(0,0.0225,-0.01408), vec3(0,0.0225,-0.01408),    
                                vec3(0.0169,0.0395,-0.1408), vec3(0.0169,0.0395,-0.1408), vec3(0.0169,0.0395,-0.1408),
                                vec3(-0.0067,-0.0296,-0.0996), vec3(-0.0067,-0.0296,-0.0996), vec3(-0.0067,-0.0296,-0.0996),
                                vec3(-0.0283,0.0323,-0.1408), vec3(-0.0283,0.0323,-0.1408), vec3(-0.0283,0.0323,-0.1408),
                                vec3(-0.0088,-0.008,0.0704), vec3(-0.0088,-0.008,0.0704), vec3(-0.0088,-0.008,0.0704),
                                ...
                                vec3(0.0227,0.0015,0), vec3(0.0227,0.0015,0), vec3(0.0227,0.0015,0),
                                ];   
        this.texture_coords = [ 
                                //Top of Wing
                                vec2(0,0.5), vec2(1,1), vec2(1,0), 
                                vec2(0,0.5), vec2(1,1), vec2(1,0),
                                vec2(0,0.5), vec2(1,1), vec2(1,0),
                                vec2(0,0.5), vec2(1,1), vec2(1,0),
                                vec2(0,0.5), vec2(1,1), vec2(1,0),
...
//Body_Segment (ratioFront, ratioBack)
//Makes a cube-like object but with the front square/face having dimensions ratioFront x ratioFront 
// and the back square/face having dimensions ratioBack x ratioBack
Declare_Any_Class( "Body_Segment",    
  { 'populate'(ratioFront = 1, ratioBack = 1)                 
      { 
        var f = ratioFront;
        var b = ratioBack;
 
        var rad3 = Math.sqrt(3); 
        this.positions.push( vec3(-1,-f,-f), vec3(-1,-f,f), vec3(-1,f,f), vec3(-1,f,-f), 
                             vec3(1,-b,-b), vec3(1,-b,b), vec3(1,b,b), vec3(1,b,-b),
                             vec3(-1,-f,-f), vec3(-1,-f,f), vec3(1,-b,-b), vec3(1,-b,b), 
                             vec3(-1,-f,f), vec3(-1,f,f), vec3(1,-b,b), vec3(1,b,b), 
                             vec3(-1,f,f), vec3(-1,f,-f), vec3(1,b,b), vec3(1,b,-b), 
                             vec3(-1,f,-f), vec3(-1,-f,-f), vec3(1,b,-b), vec3(1,-b,-b), 
        ...
        this.normals.push ( vec3(-1,0,0), vec3(-1,0,0), vec3(-1,0,0), vec3(-1,0,0),
                            vec3(1,0,0), vec3(0,0,1), vec3(0,0,1), vec3(0,0,1),
        ...
        this.indices.push( 0,1,2,  0,2,3,  4,5,6,  4,6,7,  8,9,10,  9,10,11,  12,13,14, 13,14,15, 16,17,18, 17,18,19, 20,21,22, 21,22,23 
        );    
      }
}, Shape )

//Tail
Declare_Any_Class( "Tail",    
  { 'populate'()                 
      { 
        var cone_transform = identity();
        //Center cone
        cone_transform = mult(cone_transform, scale(1,1,5));
        Closed_Cone.prototype.insert_transformed_copy_into(this, [10,10], cone_transform);
        
        //Side cones
        cone_transform = mult(identity(),translation(0,1,-2));    
        cone_transform = mult(cone_transform,rotation(-30,1,0,0));    
        cone_transform = mult(cone_transform, scale(0.7,0.7,2));
        Closed_Cone.prototype.insert_transformed_copy_into(this, [10,10], cone_transform);   
        cone_transform = mult(identity(),rotation(120,0,0,1));         
        cone_transform = mult(cone_transform,translation(0,1,-2));    
        cone_transform = mult(cone_transform,rotation(-30,1,0,0)); 
        cone_transform = mult(cone_transform, scale(0.7,0.7,2)); 
        Closed_Cone.prototype.insert_transformed_copy_into(this, [10,10], cone_transform);  
        cone_transform = mult(identity(),rotation(-120,0,0,1));         
        ...
        cone_transform = mult(identity(),translation(0,0.55,1.3));    
        cone_transform = mult(cone_transform,rotation(-30,1,0,0));    
        cone_transform = mult(cone_transform, scale(0.4,0.4,1.1)); 
        Closed_Cone.prototype.insert_transformed_copy_into(this, [10,10], cone_transform);   
        cone_transform = mult(identity(),rotation(120,0,0,1));         
        cone_transform = mult(cone_transform,translation(0,0.55,1.3));    
        cone_transform = mult(cone_transform,rotation(-30,1,0,0));    
        cone_transform = mult(cone_transform, scale(0.4,0.4,1.1)); 
        Closed_Cone.prototype.insert_transformed_copy_into(this, [10,10], cone_transform);  
        cone_transform = mult(identity(),rotation(-120,0,0,1));         
...
//Fire
Declare_Any_Class( "Fire",    
  { 'populate'()                 
      { 
        var flame_transform = identity();
        //Create center cones
        flame_transform = mult(identity(),translation(0,0,2.5));    
        flame_transform = mult(flame_transform, scale(1,1,2.5));
        Closed_Cone.prototype.insert_transformed_copy_into(this, [10,10], flame_transform);
        flame_transform = mult(identity(),translation(0,0,-1));   
        flame_transform = mult(flame_transform, scale(1,1,-1));
        Closed_Cone.prototype.insert_transformed_copy_into(this, [10,10], flame_transform);

        //Create side cones
        for (var i = 0; i < 5 ;i++){
          flame_transform = mult(identity(),rotation(72*i,0,0,1));     
          flame_transform = mult(flame_transform,translation(0,1,1.3));   
          flame_transform = mult(flame_transform, rotation(-30,1,0,0));
          flame_transform = mult(flame_transform, scale(.7,.7,1.4));
          Closed_Cone.prototype.insert_transformed_copy_into(this, [10,10], flame_transform);
        }
        for (var i = 0; i < 5 ;i++){
          flame_transform = mult(identity(),rotation(72*i + 36,0,0,1));     
          flame_transform = mult(flame_transform,translation(0,.7,2.5));   
          flame_transform = mult(flame_transform, rotation(-30,1,0,0));
          flame_transform = mult(flame_transform, scale(.4,.4,.8));
          Closed_Cone.prototype.insert_transformed_copy_into(this, [10,10], flame_transform);
        }
        for (var i = 0; i < 5 ;i++){
          flame_transform = mult(identity(),rotation(72*i,0,0,1));     
          flame_transform = mult(flame_transform,translation(0,.4,3.5));   
          flame_transform = mult(flame_transform, rotation(-30,1,0,0));
          flame_transform = mult(flame_transform, scale(.3,.3,.6));
          Closed_Cone.prototype.insert_transformed_copy_into(this, [10,10], flame_transform);
        }
      }
}, Shape )
...
//Head
Declare_Any_Class( "Head",    
  { 'populate'()                 
      { 
        this.positions      = [ 
                                //left face
                                vec3(0,0,0.25), vec3(0,0.3,0.15), vec3(0.8,0.5,0.3),
                                vec3(0,0,0.25), vec3(0.8,0.5,0.3), vec3(0.8,0,0.25),
                                vec3(0.8,0.5,0.3), vec3(0.8,0,0.25), vec3(1,0,0.15),
                                vec3(0.8,0.5,0.3), vec3(1,0.3,0.15), vec3(1,0,0.15),
                                ...
                                //front
                                vec3(0,0,-0.25), vec3(0,0.3,-0.15), vec3(-0.05,0,0),
                                vec3(0,0.3,0.15), vec3(0,0.3,-0.15), vec3(-0.05,0,0),
                                vec3(0,0,0.25), vec3(0,0.3,0.15), vec3(-0.05,0,0),
                                
                                //top
                                vec3(0,0.3,0.15), vec3(0,0.3,-0.15), vec3(0.8,0.35,-0.05),
                                vec3(0,0.3,0.15), vec3(0.8,0.35,-0.05), vec3(0.8,0.35,0.05),
                                vec3(0,0.3,-0.15), vec3(0.8,0.35,-0.05), vec3(0.8,0.5,-0.3),
                                vec3(0.8,0.35,-0.05), vec3(0.8,0.5,-0.3), vec3(1,0.3,-0.15),
                                vec3(1,0.3,0.15), vec3(1,0.3,-0.15), vec3(0.8,0.35,-0.05),
                                vec3(1,0.3,0.15), vec3(0.8,0.35,-0.05), vec3(0.8,0.35,0.05),
                                vec3(0,0.3,0.15), vec3(0.8,0.35,0.05), vec3(0.8,0.5,0.3),
                                vec3(0.8,0.35,0.05), vec3(0.8,0.5,0.3), vec3(1,0.3,0.15),

                                //back
                                vec3(1,0,-0.15), vec3(1,0.3,-0.15), vec3(1,0.3,0.15),
                                vec3(1,0,-0.15), vec3(1,0,0.15), vec3(1,0.3,0.15),
                                
                                //bottom
                                vec3(0,0,0.25), vec3(0,0,-0.25), vec3(-0.05,0,0),
                                vec3(0,0,-0.25), vec3(0,0,0.25), vec3(1,0,-0.15),
                                vec3(1,0,-0.15), vec3(1,0,0.15), vec3(0,0,0.25),
                                vec3(0,0,-0.25), vec3(1,0,0.15), vec3(1,0,-0.15),
                                vec3(1,0,-0.15), vec3(0.8,0,-0.25), vec3(0,0,-0.25),
                                vec3(1,0,0.15), vec3(0.8,0,0.25), vec3(0,0,0.25),
                              ]; 
        this.normals        = [ 
                                //left face
                                vec3(-0.015,-0.12,0.24), vec3(-0.015,-0.12,0.24), vec3(-0.015,-0.12,0.24),
                                vec3(-0.125,-0.04,0.4), vec3(-0.125,-0.04,0.4), vec3(-0.125,-0.04,0.4),
                                vec3(0.05,-0.11,0.1), vec3(0.05,-0.11,0.1), vec3(0.05,-0.11,0.1),
                                vec3(0.195,0,0.06), vec3(0.195,0,0.06), vec3(0.195,0,0.06),
                                
                                //right face
                                vec3(-0.0106,-0.0849,-0.1697), vec3(-0.0106,-0.0849,-0.1697), vec3(-0.0106,-0.0849,-0.1697),
                                vec3(-0.0884,-0.0283,-0.2828), vec3(-0.0884,-0.0283,-0.2828), vec3(-0.0884,-0.0283,-0.2828),
                                vec3(0.05,0.21,-0.1), vec3(0.05,0.21,-0.1), vec3(0.05,0.21,-0.1),
                                vec3(-0.285,0,-0.06), vec3(-0.285,0,-0.06), vec3(-0.285,0,-0.06),
                                
                                //front
                                vec3(0,0.0053,0.016), vec3(0,0.0053,0.016), vec3(0,0.0053,0.016),
                                vec3(0.0318,0.0053,0), vec3(0.0318,0.0053,0), vec3(0.0318,0.0053,0),
                                vec3(0,-0.0075,0.015), vec3(0,-0.0075,0.015), vec3(0,-0.0075,0.015),

                                //top
                                vec3(-0.0075,0.12,0), vec3(-0.0075,0.12,0), vec3(-0.0075,0.12,0),
                                vec3(-0.0075,0.12,0), vec3(-0.0075,0.12,0), vec3(-0.0075,0.12,0),
                                vec3(-0.0035,0.1414,0.0849), vec3(-0.0035,0.1414,0.0849), vec3(-0.0035,0.1414,0.0849),
                                vec3(0.1397,0.1556,0.0212), vec3(0.1397,0.1556,0.0212), vec3(0.1397,0.1556,0.0212),
                                vec3(0.04066,0.1626,0), vec3(0.04066,0.1626,0), vec3(0.04066,0.1626,0),
                                vec3(0.04066,0.1626,0), vec3(0.04066,0.1626,0), vec3(0.04066,0.1626,0),
                                vec3(-0.005,0.20,0.12), vec3(-0.005,0.20,0.12), vec3(-0.005,0.20,0.12),
                                vec3(0.0866,0.0707,0.0212), vec3(0.0866,0.0707,0.0212), vec3(0.0866,0.0707,0.0212),
        ...
        this.texture_coords = [ 
                                ...
                                vec2(0,1),vec2(0,0),vec2(.3,0),
                                vec2(0,1),vec2(.3,.6),vec2(.3,0),
                                ...
                                //front
                                vec2(1,0),vec2(0,0),vec2(1,0.5),
                                vec2(0,1),vec2(0,0),vec2(1,0.5),
                                vec2(1,1),vec2(0,1),vec2(1,0.5),

                                //top
                                vec2(0,0),vec2(0,1),vec2(1,0.6),
                                vec2(0,0),vec2(1,0.6),vec2(1,0.4),
                                vec2(0,0),vec2(1,0.6),vec2(1,1),
                                vec2(0,0),vec2(0,.3),vec2(.3,0),
                                vec2(.5,0),vec2(.5,.5),vec2(0,.4),
                                vec2(.5,0),vec2(0,.4),vec2(0,.1),
                                vec2(0,1),vec2(1,1),vec2(1,0.4),
                                vec2(0,.3),vec2(0,0),vec2(.3,.3),

                                //back
                                vec2(.5,.5),vec2(0,.5),vec2(0,0),
                                vec2(.5,.5),vec2(.5,0),vec2(0,0),
  ...
  { 'populate'()                 
      { 
        this.positions      = [                               
                                ...
                                //bottom                                
                                vec3(0,-0.1,0.25), vec3(0,-0.1,-0.25), vec3(-0.05,-0.1,0),
                                vec3(0,-0.1,-0.25), vec3(0,-0.1,0.25), vec3(1,-0.1,-0.15),
                                vec3(1,-0.1,-0.15), vec3(1,-0.1,0.15), vec3(0,-0.1,0.25),
                                vec3(0,-0.1,-0.25), vec3(1,-0.1,0.15), vec3(1,-0.1,-0.15),
                                vec3(1,-0.1,-0.15), vec3(0.8,-0.1,-0.25), vec3(0,-0.1,-0.25),
                                vec3(1,-0.1,0.15), vec3(0.8,-0.1,0.25), vec3(0,-0.1,0.25),

                                //sides
                                vec3(-0.05,0,0), vec3(0,0,0.25),vec3(-0.05,-0.1,0),
                                vec3(0,-0.1,0.25), vec3(0,0,0.25),vec3(-0.05,-0.1,0),
                                vec3(0,-0.1,0.25), vec3(0,0,0.25),vec3(0.8,0,0.25),
                                vec3(0,-0.1,0.25), vec3(0.8,-0.1,0.25),vec3(0.8,0,0.25),
                                vec3(1,0,0.15), vec3(0.8,-0.1,0.25),vec3(0.8,0,0.25),
                                vec3(1,0,0.15), vec3(1,-0.1,0.15),vec3(0.8,-0.1,0.25),
                                ...
                                vec3(1,0,-0.15), vec3(1,-0.1,-0.15),vec3(1,-0.1,0.15),
                                vec3(1,0,0.15), vec3(1,0,-0.15),vec3(1,-0.1,0.15),
        ...
        this.normals        = [ 
                                ...
                                //Sides
                                vec3(0.0212,-0.0018,-0.0035), vec3(0.0212,-0.0018,-0.0035), vec3(0.0212,-0.0018,-0.0035),
                                vec3(0.0212,-0.0018,-0.0035), vec3(0.0212,-0.0018,-0.0035), vec3(0.0212,-0.0018,-0.0035),
                                vec3(0,0,-1), vec3(0,0,-1), vec3(0,0,-1),
                                vec3(0,0,-1), vec3(0,0,-1), vec3(0,0,-1),
                                vec3(0.075,0,-0.02), vec3(0.075,0,-0.02), vec3(0.075,0,-0.02),
                                vec3(0.075,0,-0.02), vec3(0.075,0,-0.02), vec3(0.075,0,-0.02),
                                
                                vec3(0.0141,0.00177,0.0035), vec3(0.0141,0.00177,0.0035), vec3(0.0141,0.00177,0.0035),
                                vec3(0.0141,0.00177,0.0035), vec3(0.0141,0.00177,0.0035), vec3(0.0141,0.00177,0.0035),
                                vec3(0,0,1), vec3(0,0,1), vec3(0,0,1),
                                vec3(0,0,1), vec3(0,0,1), vec3(0,0,1),
                                vec3(-0.125,0,0.02), vec3(-0.125,0,0.02), vec3(-0.125,0,0.02),
                                vec3(-0.125,0,0.02), vec3(-0.125,0,0.02), vec3(-0.125,0,0.02),
        ...
        this.texture_coords = [ 
                                ...
                                //Bottom
                                vec2(.1,1),vec2(.1,0),vec2(0,.5),
                                vec2(.1,0),vec2(.1,1),vec2(1,.3),
                                vec2(1,.3),vec2(1,.7),vec2(.1,1),
                                vec2(.1,0),vec2(1,.7),vec2(1,.3),
                                vec2(1,.3),vec2(.8,0),vec2(.1,0),
                                vec2(1,.7),vec2(.8,1),vec2(.1,1),

                                //Sides
                                vec2(0,1),vec2(0,0),vec2(.2,1),
                                vec2(.2,0),vec2(0,0),vec2(.2,1),
                                vec2(0,0),vec2(0,.2),vec2(1,.2),
                                vec2(0,0),vec2(1,0),vec2(1,.2),
                                vec2(.3,.2),vec2(0,0),vec2(0,.2),
                                vec2(.3,.2),vec2(.3,0),vec2(0,0),   
                                ...
                                vec2(0,.5),vec2(.15,.5),vec2(.15,0),
                                vec2(0,0),vec2(0,.5),vec2(.15,0),                             
